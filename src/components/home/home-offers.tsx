...
export function HomeOffers({
  ...
  return (
    <section className="bg-[#FFF4F3] py-20 lg:py-24">
      <div className="mx-auto grid max-w-7xl gap-6 px-5 lg:grid-cols-2 lg:px-8">
        {promotion ? (
          <article className="relative overflow-hidden rounded-[36px] bg-[#241A1D] p-8 text-white sm:p-10">
            <div className="absolute -right-20 -top-20 size-64 rounded-full bg-[#E8B4B8]/20 blur-3xl" />
            ...
            <div className="relative">
              ...
              <p className="mt-7 text-xs font-semibold uppercase tracking-[0.25em] text-[#E8B4B8]">
                Offre du moment
              </p>
        ...
        {contest ? (
          <article className="relative overflow-hidden rounded-[36px] border border-[#241A1D]/7 bg-white p-8 sm:p-10">
            <div className="absolute -bottom-20 -right-20 size-60 rounded-full bg-[#C9A36A]/15 blur-3xl" />
            ...
            <div className="relative">
              <div className="flex items-start justify-between">
                ...
                <Sparkles className="size-6 text-[#C9A36A]" />
              </div>

              <p className="mt-7 text-xs font-semibold uppercase tracking-[0.25em] text-[#A06F81]">
                Jeu concours
              </p>
              ...
              <p className="mt-4 max-w-lg leading-7 text-[#75636A]">
                {contest.description}
              </p>

              <div className="mt-6 flex items-start gap-3 rounded-2xl bg-[#FFF8EE] p-4">
                <Gift className="mt-0.5 size-5 shrink-0 text-[#B48B51]" />
