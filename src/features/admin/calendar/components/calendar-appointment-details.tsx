...
export function CalendarAppointmentDetails(
  props: CalendarAppointmentDetailsProps,
) {
  return (
    <CalendarAppointmentDetailsContent
      key={
...
function CalendarAppointmentDetailsContent({
  appointment,
  onClose,
  onUpdated,
