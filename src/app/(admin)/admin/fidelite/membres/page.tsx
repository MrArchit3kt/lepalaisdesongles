...
import {
  AdminVipMembersManager,
} from "@/features/admin/vip/components/admin-vip-members-manager";

import {
  getAdminVipMembersPageData,
...
export default async function AdminVipMembersPage() {
  await requireAdminUser();

  const data =
    await getAdminVipMembersPageData();
        ...
        <section className="relative mt-5 overflow-hidden rounded-[2rem] bg-zinc-950 px-6 py-8 text-white shadow-xl sm:px-8 lg:px-10">
          ...
          <div className="relative">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-300">
              Consultez les comptes VIP, les niveaux, les points, l’expérience,
              les dépenses et les récompenses des clientes.
            </p>
            ...
            <div className="mt-5 inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-zinc-300">
              ...
              Chaque fiche membre donne accès aux opérations administratives et
