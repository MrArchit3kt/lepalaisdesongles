...
function VipPreLaunchPage({
  ...
  return (
    <main className="min-h-[calc(100vh-80px)] bg-[#FFF9F8] px-4 py-10 sm:px-6">
      <div className="mx-auto max-w-5xl">
        <section className="relative overflow-hidden rounded-[2rem] bg-[#241A1D] p-6 text-white shadow-xl sm:p-10 lg:p-14">
          <div className="absolute -right-28 -top-28 size-96 rounded-full bg-violet-600/30 blur-3xl" />

          <div className="absolute -bottom-32 left-1/3 size-80 rounded-full bg-fuchsia-500/20 blur-3xl" />

          <div className="relative grid gap-10 lg:grid-cols-[1fr_360px] lg:items-center">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-3 py-1.5 text-xs font-black uppercase tracking-[0.18em]">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                {buttonUrl ? (
                  <Link
                    href={buttonUrl}
                    className="inline-flex h-12 items-center justify-center rounded-xl bg-violet-600 px-6 text-sm font-black text-white transition hover:bg-violet-500"
                  >
                    {buttonLabel ??
                      "En savoir plus"}
                  </Link>
            ...
            <div className="overflow-hidden rounded-[1.75rem] border border-white/10 bg-white/10 p-3">
              {imageUrl ? (
                ...
                <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-gradient-to-br from-violet-600/50 to-fuchsia-500/20">
        ...
        "PAUSED" ? (
          <section className="rounded-[1.5rem] border border-amber-200 bg-amber-50 p-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h1 className="font-black text-amber-950">
